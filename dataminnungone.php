...
?>
	 ...
	 <div class="row">
  	 <div class="col-sm-4">
<?php
echo "<pre><br><h2>Movie Item </h2>";
echo "<table class=table border=\2\>";
echo " <tr><td>Movie Item</td></tr>";
...
$myarray2 = array();
  ...
  echo "<table class=table border=\2\>";
  echo "<tr><td>Item Set</td><td>Confidence</td><td>Lift Ratio</td></tr>";
  $query01= "DROP TABLE dataminnungone";
...
$query01= "CREATE TABLE dataminnungone (
...
echo "failure:".mysqli_error($con);
      ...
      $query2 = "INSERT INTO dataminnungone (film,filmget,support,type) VALUES('$oneitemset','$item_name33','$supt','$moviestype[$item_name33]')";
